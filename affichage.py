...
class Game:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Just a Plumber")
    ...
    def update(self, face):
        ...
        for sprite in self.group.sprites():
            if self.player.rect.collidelist(self.collide) != -1 and self.player.rect.collidelist(
                    self.collide_bas) != -1:
    ...
    def run(self):
        ...
        while running:
            ...
            self.screen.blit(self.player.sprite,
                             (a_x, a_y))  # Afficher le personnage au coordonnées a_x et a_y redimensionné
